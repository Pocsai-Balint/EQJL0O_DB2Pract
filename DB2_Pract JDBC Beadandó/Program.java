        ...
        while (true) {
            ...
            switch (v) {
                ...
                case 2:
                     ...
                     String kolcsonzoNev = cm.readString("Kölcsönző neve:");
                     String kolcsonzesDatum = cm.readDate("Kölcsönzés dátuma");
                     int dij = cm.readPositiveInt("Díj:");

                    DbMethods.InsertKolcsonzes(konyvID, kolcsonzoNev, kolcsonzesDatum, dij);
                    break;
